...
count=1
print "{:10} {:18} {:14} {}".format('count','wavelength','B(a3)','a3-a2')
...
count=1
print "{:10} {:18} {:14} {}".format('count','wavelength','B(b3)','b3-b2')
print "{:3} {:.14e} {:.10e} {:.14e}".format(count,a3,B(a3),a3-a2)
...
print "\n"       
print "Wavelengths which correspond to B(T)=10^13 J/s/m^3 are {:.10f}nm and {:.10f}nm".format(b3*1e+9,a3*1e+9)
